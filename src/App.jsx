  ...
  return (
   <>
      ...
      <div className="flex items-center flex-col">
         ...
         <button onClick={() => { generateAns(); setQuestion(""); }} className="shadow-md mt-2 m-1 py-2 px-3 border-2 rounded-xl border-none active:bg-lime-800 bg-lime-950 text-white">Generate Ans</button>
      </div>
